...
public class EmailServiceImpl implements EmailService {
    ...
    private static final List<String> SCOPES = Arrays.asList(GmailScopes.GMAIL_INSERT, GmailScopes.MAIL_GOOGLE_COM);
    ...
    @Override
    public boolean makeDraftEmail(DraftEmailCreateRequest request) throws MessagingException, IOException, GeneralSecurityException {
        String provider = request.getProvider();
        if (provider.equalsIgnoreCase(MailProvider.GMAIL.name())) {
            createDraftGMail(createMessage(request, Session.getInstance(System.getProperties())), request.getEmail());
    ...
    private MimeMessage createMessage(DraftEmailCreateRequest request, Session session) throws MessagingException {
