...
public class ChromeDriverEx extends ChromeDriver {
  ...
  public ChromeDriverEx(ChromeDriverService service, ChromeOptions options) throws Exception {
    ...
    CommandInfo cmd = new CommandInfo("/session/:sessionId/chromium/send_command_and_get_result",
        HttpMethod.POST);
    Method defineCommand = HttpCommandExecutor.class
        .getDeclaredMethod("defineCommand", String.class, CommandInfo.class);
  ...
  public <X> X getFullScreenshotAs(OutputType<X> outputType) {
    ...
    Object result = sendCommand("Page.captureScreenshot",
  ...
  protected Object sendEvaluate(String script) {
    Object response = sendCommand("Runtime.evaluate",
